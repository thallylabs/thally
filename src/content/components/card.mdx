...
<CardGroup cols={2}>
  ...
  <Card title="Guides" icon="book-open" href="/guides/writing-content">
...
```mdx
<CardGroup cols={2}>
  <Card title="Analytics Dashboard" img="/images/dashboard.svg" href="/quickstart">
    Monitor active users and conversion rates.
  </Card>
  <Card title="API Explorer" img="/images/explorer.svg" href="/api">
...
<CardGroup cols={3}>
  <Card title="Navigation" icon="link-simple" href="/guides/configuring-navigation">
    Structure tabs, sidebar groups, and page order with docs.json.
  </Card>
  <Card title="Custom Fonts" icon="book-open" href="/guides/custom-fonts">
    Switch to any Google Font from docs.json — no code changes.
  </Card>
  <Card title="Deploying" icon="party-horn" href="/guides/deploying">
    Ship to Vercel, Netlify, Cloudflare, or a Docker container.
  </Card>
</CardGroup>
...
<CardGroup cols={3}>
  <Card title="Navigation" icon="link-simple" href="/guides/configuring-navigation">
    Structure tabs and groups with docs.json.
  </Card>
  <Card title="Custom Fonts" icon="book-open" href="/guides/custom-fonts">
    Switch fonts from docs.json.
  </Card>
  <Card title="Deploying" icon="party-horn" href="/guides/deploying">
    Ship to any Next.js host.
  </Card>
</CardGroup>
```
