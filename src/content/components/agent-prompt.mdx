...
coding agent. The callout leads with **Prefer to let an agent do it?**, adds a
task-specific description and secondary **Copy prompt** action, and keeps the
full instructions hidden until the reader copies them.
...
| `heading` | string | `Prefer to let an agent do it?` | Short invitation above the task-specific description. |
| `title` | string | Copy-and-paste instruction | Task-specific description shown beside the copy action. |
