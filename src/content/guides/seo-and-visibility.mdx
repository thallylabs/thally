...
Dox gives you fine-grained control over which pages are visible in the sidebar, which are indexed by search engines, and which appear in the AI search context.
...
By default, hidden pages are excluded from the AI search context. To include them (for example, to make internal notes searchable within the DoxAI chat), set:
