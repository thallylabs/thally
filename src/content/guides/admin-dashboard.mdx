...
| **Docs tasks** | Documentation edits drafted by the docs agent as pull requests. |
| **MCP server** | Enable or disable the public `/api/mcp` endpoint. |
| **Team** | Members, domains, and roles for admin access. |
| **Branding** | Structural theme, brand accent, logo, and favicon (see [Branding and theming](/guides/branding-and-theming)). |
| **Settings** | Feature toggles, site identity, docs-access password, and the AI chat key. |
