---
title: Extending Dox
description: Dox is a docs platform you own and build on — add custom components, pages, API routes, themes, and more without forking core.
keywords:
  - extend
  - customize
  - custom components
...
Dox isn't a black box you configure from the outside — a Dox project is a
...
any functionality your team needs, and Dox gives you clean, update-safe surfaces
...
```mdx
Dox is <Highlight>yours to extend</Highlight>.
```
</Step>
</Steps>
...
<Note type="tip">
Look at `src/components/mdx/rich-content.tsx` to see how Dox's own components are
built — it's the best reference for writing your own.
</Note>

## Custom pages and routes

Because Dox is a Next.js App Router project, any file you add under `src/app/`
