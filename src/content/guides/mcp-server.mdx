---
title: MCP Server
description: Use @doxlabs/mcp to manage Dox projects with Claude, Cursor, or any MCP-compatible AI tool.
---

`@doxlabs/mcp` is a [Model Context Protocol](https://modelcontextprotocol.io) server that lets AI tools — Claude Code, Claude Desktop, Cursor, Windsurf — create, read, update, and migrate Dox documentation projects through natural language.

## Setup

Add `@doxlabs/mcp` to your Claude Code or Claude Desktop configuration:
