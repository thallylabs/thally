...
discovery files, search, and MCP. Most of those agent-facing surfaces are free
and self-hosted.
...
Thally Cloud adds an assistant button to the documentation navbar that lets readers ask questions and get answers grounded in your actual documentation, with inline citations back to the exact pages and anchors. Readers can also open it with <kbd>⌘I</kbd> (or <kbd>Ctrl+I</kbd>).
