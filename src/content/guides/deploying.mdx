...
| `DOX_AUTH_SECRET` | Signs admin sessions and encrypts stored secrets (required with OIDC) |

Only `DOX_SITE_URL` is needed for a basic docs site. See [Admin dashboard & team access](/guides/admin-dashboard) for the auth variables in context.
