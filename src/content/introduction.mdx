...
<Hero
  ...
  subtitle="Thally is a production-ready docs platform built on the Next.js App Router, MDX, and Tailwind CSS. Write in Markdown, own your stack, and ship a site that's fast for humans and legible to AI."
