 ...
 * arbitrary code execution inside whatever process reads the file. Content is
 * customer-authored, so every parse must route through this helper rather
 * than calling `matter()` directly.
 *
